...
def build_style_sheet(base_px: int = 13) -> str:
    title_px = base_px + 8
    panel_title_px = base_px + 1
    log_px = max(10, base_px - 1)
    return f"""
QMainWindow, QWidget {{
    background: #101318;
    color: #eef2f7;
...
# Keep backward compatibility for any direct STYLE_SHEET imports.
STYLE_SHEET = build_style_sheet()
