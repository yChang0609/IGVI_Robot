...
class DoorMissionCoordinator:
    ...
    def cancel(self) -> tuple[bool, str]:
        ...
        if phase == "navigating":
            ...
            # Nav2 already finished (plan-only stack returns SUCCESS immediately);
            # the drive lives in motion_arbiter. The bridge stops it by publishing
            # /motion/clear_path before calling cancel() — nothing for us to do here.
            msg = "path cleared; arbiter stopped"
        elif phase == "opening":
